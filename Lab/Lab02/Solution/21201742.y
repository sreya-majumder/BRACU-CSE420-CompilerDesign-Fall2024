...
%token IF ELSE FOR NOT LPAREN RPAREN LCURL RCURL WHILE DO BREAK CONTINUE RETURN INT FLOAT CHAR VOID DOUBLE SWITCH CASE DEFAULT PRINTLN ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP LTHIRD RTHIRD SEMICOLON COMMA ID CONST_INT CONST_FLOAT
...
declaration_list : declaration_list COMMA ID
		{
			...
			$$ = new symbol_info($1->getname()+","+$3->getname(),"var_declaration");	
		}
		|  declaration_list COMMA ID LTHIRD CONST_INT RTHIRD
		{
			...
			$$ = new symbol_info($1->getname()+","+$3->getname()+"["+$5->getname()+"]","var_declaration");
		}
		| ID	
		{
...
arguments : arguments COMMA logic_expression
	  {
			...
			$$ = new symbol_info($1->getname()+"," +$3->getname() ,"argument");
	  }
	  | logic_expression
	  {
			...
			$$ = new symbol_info($1->getname() ,"argument");
	  }
	  ;
